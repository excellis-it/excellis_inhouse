...
import InnerBanner from "../../src/InnerBanner";
...
const About = () => {
  ...
  return (
    <div>
      ...
      <section className="banner_after">
        <div className="container">
          <div className="locla">
            <div className="text_locla">
              <h2>THE EXCELLIS STORY</h2>
            </div>
          </div>
          <div className="locla_text">
            <div className="row">
              <div className="col-xl-5 order-2 order-sm-1" data-aos="fade-up">
                <p>
              ...
              <div className="col-xl-7 order-1 order-sm-2">
                <div
                  className="reveal-holder custom_aos"
                  data-aos="reveal-item"
                >
                  <div
                    className="reveal-block right custom_aos"
          ...
          <div className="four">
            <div className="locla1">
              <h2>THE EXCELLIS STORY</h2>
            </div>
            <p className="black_p" data-aos="fade-up">
              ...
              <div className="row">
                ...
                <div className="col-xl-3 col-6">
                  <div className="item_a">
                    <div className="title-inner">
                      ...
                      <h3 className="txt-c">REAL TIME PROJECT STATUS</h3>
                    </div>
                  </div>
                </div>
                <div className="col-xl-3 col-6">
                ...
                <div className="col-xl-3 col-6">
                  <div className="item_a">
                    <div className="title-inner">
                      ...
                      <h3 className="txt-c">
                        HEAVY INVOLVEMENT FROM OUR CLIENTS
                      </h3>
                    </div>
                  </div>
                </div>
                <div className="col-xl-3 col-6">
                  <div className="item_a">
                    <div className="title-inner">
                      <div className="abt_we_icon">
                        <i className="ph-handshake"></i>
                      </div>
                      <h3 className="txt-c">ONSITE COLLABORATION</h3>
                    </div>
                  </div>
                </div>
                <div className="col-xl-3 col-6">
                ...
                <div className="col-xl-3 col-6">
                  <div className="item_a">
                    <div className="title-inner">
                      <div className="abt_we_icon">
                        <i className="ph-lightbulb-filament"></i>
                      </div>
                      <h3 className="txt-c">INNOVATION & STRATEGY</h3>
                    </div>
                  </div>
                </div>
              </div>
